...
function getRolePortalPath(role) {
  console.log('[ROLE-NORMALIZER] INPUT role:', role, 'type:', typeof role);

  const normalized = normalizeRole(role);
  console.log('[ROLE-NORMALIZER] NORMALIZED role:', normalized);
  ...
  console.log('[ROLE-NORMALIZER] FINAL path for role', role, '→', path);
  return path;
}

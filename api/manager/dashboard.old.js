...
const { requireRoles } = require('../_utils/require-roles');
...
module.exports = requireRoles(['manager', 'admin', 'super_admin'])(async function handler(req, res) {
  ...
  try {
    ...
    // User context should already be attached by requireRoles
